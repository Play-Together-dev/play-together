...
Button::Button(SDL_Renderer *renderer, TTF_Font *font, ButtonPosition position, std::string buttonText,
...
Button::Button(SDL_Renderer *renderer, TTF_Font *font, ButtonPosition position, std::string buttonText,
        ...
        renderer(renderer), font(font), buttonText(std::move(buttonText)), position(position), borderRadius(borderRadius),
        buttonAction(buttonAction), normalColor(normalColor), hoverColor(hoverColor), textColor(textColor) {
}
...
void
Button::handleEvent(SDL_Event const &event) {
